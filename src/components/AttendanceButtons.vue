<template>
  <div class="flex -space-x-px text-gray-600 items-center" v-if="!loading.attendance">
    <button
        :class="{'bg-gray-200 hover:bg-gray-300 text-gray-800 border-gray-300': attendance && attendance.answer === 1}"
    ...
    <button
        :class="{'bg-gray-200 hover:bg-gray-300 text-gray-800 border-gray-300': attendance && attendance.answer === 2}"
    ...
    <button
        :class="{'bg-gray-200 hover:bg-gray-300 text-gray-800 border-gray-300': attendance && attendance.answer === 3}"
